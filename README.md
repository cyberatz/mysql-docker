...
Run command: 
docker run --rm --name mysql -e MYSQL_ROOT_PASSWORD=pass1234 -e MYSQL_DATABASE=BDM_Direct -e MYSQL_ROOT_HOST="%" -v /data/sql:/var/lib/mysql -p 3306:3306 andrevs/mysql &
